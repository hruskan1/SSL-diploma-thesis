...
class CityScapeDataset(torchvision.datasets.Cityscapes):
    ...
    classes = [
        ...
        CityscapesClass("license plate",        -1,       7,  "vehicle",            7,          False,      True,    (  0,   0, 142)),
    ]
    ...
    class_weights = [0,1,1,1,1,1,1,1] # ignore 0 class (unlabeled)
    custom_class_weights = [0,1,1,5,3,1,5,2] #manually twiddle class weights
    # for mode == fine 
