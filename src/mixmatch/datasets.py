...
class CityScapeDataset(torchvision.datasets.Cityscapes):
    ...
    classes = [
        ...
        CityscapesClass("sidewalk",             8,        2,  "flat",               1,          False,      False,   (244,  35, 232)),
        CityscapesClass("parking",              9,        3,  "flat",               1,          False,      True,    (250, 170, 160)),
        CityscapesClass("rail track",           10,       4,  "flat",               1,          False,      True,    (230, 150, 140)),
        CityscapesClass("building",             11,       5,  "construction",       2,          False,      False,   ( 70,  70,  70)),
        CityscapesClass("wall",                 12,       6,  "construction",       2,          False,      False,   (102, 102, 156)),
        CityscapesClass("fence",                13,       7,  "construction",       2,          False,      False,   (190, 153, 153)),
        CityscapesClass("guard rail",           14,       8,  "construction",       2,          False,      True,    (180, 165, 180)),
        CityscapesClass("bridge",               15,       9,  "construction",       2,          False,      True,    (150, 100, 100)),
        CityscapesClass("tunnel",               16,       10, "construction",       2,          False,      True,    (150, 120,  90)),
        CityscapesClass("pole",                 17,       11, "object",             3,          False,      False,   (153, 153, 153)),
        CityscapesClass("polegroup",            18,       12, "object",             3,          False,      True,    (153, 153, 153)),
        CityscapesClass("traffic light",        19,       13, "object",             3,          False,      False,   (250, 170,  30)),
        CityscapesClass("traffic sign",         20,       14, "object",             3,          False,      False,   (220, 220,   0)),
        CityscapesClass("vegetation",           21,       15, "nature",             4,          False,      False,   (107, 142,  35)),
        CityscapesClass("terrain",              22,       16, "nature",             4,          False,      False,   (152, 251, 152)),
        CityscapesClass("sky",                  23,       17, "sky",                5,          False,      False,   ( 70, 130, 180)),
        CityscapesClass("person",               24,       18, "human",              6,          True,       False,   (220,  20,  60)),
        CityscapesClass("rider",                25,       19, "human",              6,          True,       False,   (255,   0,   0)),
        CityscapesClass("car",                  26,       20, "vehicle",            7,          True,       False,   (  0,   0, 142)),
        CityscapesClass("truck",                27,       21, "vehicle",            7,          True,       False,   (  0,   0,  70)),
        CityscapesClass("bus",                  28,       22, "vehicle",            7,          True,       False,   (  0,  60, 100)),
        CityscapesClass("caravan",              29,       23, "vehicle",            7,          True,       True,    (  0,   0,  90)),
        CityscapesClass("trailer",              30,       24, "vehicle",            7,          True,       True,    (  0,   0, 110)),
        CityscapesClass("train",                31,       25, "vehicle",            7,          True,       False,   (  0,  80, 100)),
        CityscapesClass("motorcycle",           32,       26, "vehicle",            7,          True,       False,   (  0,   0, 230)),
        CityscapesClass("bicycle",              33,       27, "vehicle",            7,          True,       False,   (119,  11,  32)),
