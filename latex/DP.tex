...
% Intorduction and Mixmatch
\input{_ssl}
% VAE
\input{_vae}
\todo{Exponential Family introduction}
\todo{Vae development, HVAE,ladder networks,blurriness issue etc.}
\todo{sym learning vae}
\input{_exp_family.tex}
% Symmetrical learning paper
\input{_sym_learning.tex}
