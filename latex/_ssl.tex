...
\begin{enumerate}
    ...
    \item \textbf{MixUp}: Before we continue in further description, we define the slightly alternated version of the vannila MixUp \cite{mixup-2018}.
        ...
        resp. $\mathcal{U}$.
\end{enumerate}
\todo{Add the figure of label guessing procedure from the original paper?}

\todo{Add the pseudo code from the original paper?}

\todo{Write about adaptation to the image segmentation?}
